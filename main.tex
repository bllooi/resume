...
\small{I am a recent graduate in Applied Mathematics achieved at Colorado State University. I have a passion for mathematics and programming, specifically where mathematical concepts are used to improve and optimize a progressively digital world.}
...
\vspace{0.75em}
\begin{itemize}
\item{\cventry{July 2021 -- Present}{Stampede Solution -- C\# Volare Development Team}
  {Software Engineer}{Kuala Lumpur, Malaysia}{}{
    \begin{itemize}
    \item Improved and optimized Volare, the main FinTech product, to decrease workflow ineffeciencies of users
    \item Identified and mitigated multiple complex, critical flaws with product
