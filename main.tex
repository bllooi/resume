...
\begin{itemize}
    ...
    \item {Frameworks \& Tools:} NumPy, Websocket, Numba, PyTables, Jupyter, Git, Docker, Powershell, EC \& DLP cryptosystems
\end{itemize}
\vspace{0.5em}
...
\begin{itemize}
  ...
  {Software Developer}{Penang, Malaysia}{}{
    \begin{itemize}
      \item Develop and maintain a high-frequency trading platform for large-scale daily trade volumes
      ...
      \item Engage in key areas of the tech stack: market data, order management, IPC, monitoring, alerting, and UI
    \end{itemize}
}}
\vspace{0.75em}
